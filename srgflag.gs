...
*'set strsiz 0.1'
*'draw string 0.05 2.4'

'set string 0 tr 5'
'set strsiz 0.2 '
'draw string 8.8 8.3 Estimated Position of Momentum Surges'
...
if (command='r')
  if (mintim < 10)
    ...
    'printim FlagSurge_0000'mintim'.png x1400 y1000'
  endif
  if (mintim < 100 & mintim >= 10)
    say 'Saving PNG graphic in current directory'
    'printim FlagSurge_000'mintim'.png x1400 y1000'
  endif
  if (mintim < 1000 & mintim >= 100)
    say 'Saving PNG graphic in current directory'
    'printim FlagSurge_00'mintim'.png x1400 y1000'
  endif 
  if (mintim < 10000 & mintim >= 1000)
    say 'Saving PNG graphic in current directory'
    'printim FlagSurge_0'mintim'.png x1400 y1000'
  endif
  if (mintim < 100000 & mintim >= 10000)
    say 'Saving PNG graphic in current directory'
    'printim FlagSurge_'mintim'.png x1400 y1000'
  endif
endif
