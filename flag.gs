...
'zeta = ((cdiff(v,x) - cdiff(u,y)) / 500) * 100'

'color 0 1 0.5 -kind white->black'
'd srgflag'
...
'set string 0 tr 5'
'set strsiz 0.2 '
'draw string 8.7 8.2 Momentum Surges (shaded) and Vertical Velocity'
...
if (command='r')
  if (mintim < 10)
    ...
    'printim SrgFlag_0000'mintim'.png x1400 y1000'
  endif
  if (mintim < 100 & mintim >= 10)
    say 'Saving PNG graphic in current directory'
    'printim SrgFlag_000'mintim'.png x1400 y1000'
  endif
  if (mintim < 1000 & mintim >= 100)
    say 'Saving PNG graphic in current directory'
    'printim SrgFlag_00'mintim'.png x1400 y1000'
  endif
  if (mintim < 10000 & mintim >= 1000)
    say 'Saving PNG graphic in current directory'
    'printim SrgFlag_0'mintim'.png x1400 y1000'
  endif
  if (mintim < 100000 & mintim >= 10000)
    say 'Saving PNG graphic in current directory'
    'printim SrgFlag_'mintim'.png x1400 y1000'
  endif
endif
