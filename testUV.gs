...
'uprime = abs(uinterp+7)'
'vprime = abs(vinterp+5)'

'color 0 20 0.2 -kind white->green->yellow->orange->red'
'd vprime'
...
'set strsiz 0.085'
'draw string 0.05 2.4  Deg m s-1'

'set string 0 tr 5'
'set strsiz 0.17'
'draw string 8.9 8.2 Internal Surge Index (shaded) SFC velocity'
...
if (command='r')
  IF (mintim < 10)
    ...
    'printim  surgeindex_00000'mintim'.png x1400 y1000'
  endif
  if (mintim <100 & mintim >= 10)
    'printime surgeindex_0000'mintim'.png x1400 y1000'
  endif
  if (mintim < 1000 & mintim >=100)
    'printim surgeindex_000'mintim'.png x1400 y1000'
  endif
  if (mintim < 1000 & mintim >=100)
    'printim surgeindex_00'mintim'.png x1400 y1000'
  endif
  if (mintim < 10000 & mintim >= 1000)
    'printim surgeindex_0'mintim'.png x1400 y1000'
  endif
  if (mintim < 100000 & mintim >= 10000)
    'printim surgeindex_'mintim'.png x1400 y1000'
  endif
endif
